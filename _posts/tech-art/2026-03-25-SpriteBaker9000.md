...
priority: 7
pin: false
takeaway: Working with multiple artist workflows taught me that the best tools are ones that meet people where they are, not where you think they should be. The compositing pipeline is the heart of the tool — everything else is just convenience.
image:
