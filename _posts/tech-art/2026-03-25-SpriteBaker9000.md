...
tags: [project, tool, 2D, 3D, shader]
section: tech-art
engine: Blender
role: Solo Developer
team_size: Solo
...
priority: 7
pin: false
takeaway: Working with multiple artist workflows taught me that the best tools need to meet people where they are, not where you think they should be. A tool should make it easy for artists to do what they want and minimize manual tedious labor not add a layer to that aforementioned tediousness.
image:
...
![posterized image](example2.png){: width="200" }
...
![64x64 example](example3.png){: style="image-rendering: pixelated; width: 64px;" } ![16x16 example](example4.png){: style="image-rendering: pixelated; width: 64px;" }
...
![64x64 example](example5.png){: style="image-rendering: pixelated; width: 64px;" } ![16x16 example](example6.png){: style="image-rendering: pixelated; width: 64px;" }
...
<video src="{{ '/assets/media/SpriteBaker9000/Unity_rjmsIe6xrm.mp4' | relative_url }}" autoplay muted loop playsinline aria-label="SpriteBaker9000 in Unity"></video>
